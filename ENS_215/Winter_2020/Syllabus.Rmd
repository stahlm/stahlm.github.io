...
## Course sites
 + [**This website**](https://stahlm.github.io/ENS_215/Website/ENS_215_Site.html): The site you are on now will be updated throughout the term.  In particular the schedule will have material added on a weekly basis.
 + [**Nexus:**](https://nexus.union.edu)  You will submit all of your assignments through our Nexus class site 
 + [**DataCamp:**](https://www.datacamp.com/enterprise/environmental-data-analysis) The online assignments/tutorials can be found on our DataCamp class site
...
## Useful links
 ...
 + [**r-statistics.co**](http://r-statistics.co/):  Great resource with easy to follow R tutorials and examples.  
 ...
 + [**YaRrr! The Pirates Guide to R**](https://bookdown.org/ndphillips/YaRrr/): Another introductory textbook that presents the material concisely.  This book is freely available online. 
...
+ [**National Institutes of Standards and technology (NIST) Engineering Statistics Handbook**](https://www.itl.nist.gov/div898/handbook/index.htm): Excellent resource on statistics and exploratory data analysis, however it may be a bit challenging for those without a background in statistics.
...
## Computer use
We will use computers in all of our class and lab meetings.  If you have a personal laptop you can use it or you can use the computers in the classroom.  **Using your computer for anything not related to the class is unacceptable and will adversely impact your participation grade**.  Among other things, this means that you should not check email, Facebook, Twitter, news, or any other content not directly related to the coursework during class/lab meetings.  Your undivided attention and focus is important to your success in this class.
