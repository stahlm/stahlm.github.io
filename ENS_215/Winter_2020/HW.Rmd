...
### Week 9
#### Readings
* [**Geocomputation with R (Ch: 8)**](https://geocompr.robinlovelace.net/adv-map.html) (Optional reading)
...
2. If you haven't done so yet, complete the survey I emailed out last week.  As a reminder, the survey is anonymous and is part of a project to develop and improve computing curriculums outside of computer science departments.  
...
#### Assignments 
1. DataCamp **_Cleaning Data in R_** chapters **1** ("Introduction and exploring raw data") and **2** ("Tidying data")
    + Assigned: 31-Jan
    + Due: 5-Feb
    
2. DataCamp **_Cleaning Data in R_** chapters **3** ("Preparing data for analysis") and **4** ("Putting it all together")
    + Assigned: 31-Jan
    + Due: 7-Feb
