...
You should also consult your [R Markdown cheatsheet](https://stahlm.github.io/ENS_215/Resources/Cheatsheets_all.pdf), which has a bunch of helpful examples for formatting your documents (e.g., including equations, adding images, text formatting, lists, footnotes,...).  
...
#### Table of contents
You can add a table of contents (which I add to all of our lecture documents) by modifiying the YAML header at the top of your Rmd file.  Take a look at [chapter 3.1.1](https://bookdown.org/yihui/rmarkdown/html-document.html#table-of-contents) for details.  
