...
In the past few lectures you've learned some basics of spatial analysis in R.  In particular you've learned how to perform basic mathematical operations and data wrangling operations on geospatial data object, make basic maps, and access spatial data directly from calls to the US Census geographic database (using `tigris`).  
