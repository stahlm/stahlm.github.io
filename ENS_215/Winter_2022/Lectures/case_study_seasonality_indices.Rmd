...
You'll see in the `met_df` data frame that we have daily meteorological data for Albany International Airport for 2012-2021.  Let's go ahead and compute the monthly means so that we can use our `compute_seasonality_indices()` function to calculate SI and SC on the precipitation data.  
