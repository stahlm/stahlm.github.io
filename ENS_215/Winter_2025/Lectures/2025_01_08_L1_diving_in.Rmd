...
met_data <- mutate(met_data, DATE = parse_date_time(DATE,"ymd")) # convert date into computable format
...
Let's create another figure, this time just for the data from 2000-2010.  Our figure will have a separate panel for each of the years.  This figure will be more complex and involve a couple additional transformations of the data to allow us to make the plot.   
