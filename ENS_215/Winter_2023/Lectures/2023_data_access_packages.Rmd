...
```{r}
met_df <- get_GSOD(years = 2022:2023, station = "681100-99999")
```
...
Let's plot the a time-series of the daily minimum and maximum air temperatures from 2022-2023 at the selected met station.  
...
Let's go ahead and download hourly data for Albany International Airport (station code: 725180-14735) for 2022 through the most recent reported measurement (~ 1 or 2 days prior to today).  
