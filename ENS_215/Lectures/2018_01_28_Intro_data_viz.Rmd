...
3. Recreate, with modification, any of the graphics we made in today's class.  For instance you may want to modify the shape or size aesthetic, adjust the alpha, or layer on additional `geom`s.  
