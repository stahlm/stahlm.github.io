...
As you work through the code, pay close attention and make sure that you understand what is happening in each line of code.  Check help files, ask your neighbor, Google questions, and of course ask me if you have any questions or don't fully understand something.  
...
2. Create a new data frame that meets the following conditions
    ...
    + Only has entries with with a gdp per capita that is greater than 15000 
...
6. How many countries in 2007 had both a per capita GDP greater than 10,000 a life expectancy less than 60?
