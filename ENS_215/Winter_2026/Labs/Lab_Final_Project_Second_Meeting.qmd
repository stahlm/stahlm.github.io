...
You should have the following ready when I come around:
  ...
  + Any R Quarto Notebooks that you've put together thus far to begin loading the data in to R and to begin performing your analysis.
      + In your R Quarto Notebooks you should show me that you are using **relative paths** when reading or writing files.
