...
format:
  html:
    ...
    toc: true
    toc-float: true
    include-in-header: "icon_ens215.html"
---
...
# Course Information
**Term:** Winter 2026  
**Location:** Olin 307 (_Class_) and Olin 306 (_Lab_)    
**Meeting times:** 

  + **Class:** T/Th, 9:10-10:45 AM
  + **Lab:** Th, 1:55-4:45 PM  


**Professor:** [Mason Stahl](https://sites.google.com/union.edu/masonstahl/home)  (stahlm@union.edu)  
**TA:** Amelia Casassa (casassaa@union.edu)  
**Office hours:** Olin 102A -- Mondays 9:30-11:30 AM and Thursdays 10:50-11:50 AM 
...
## Learning objectives
### In the context of environmental science and the geosciences you will learn:  
> + How to formulate thoughtful, creative, and meaningful scientific questions  
 + How to identify the analytical approaches and data required to answer scientific questions  
 + How to assess the limitations and applicability of a given dataset   
 + How to use logical and algorithm approaches through computer code (R programming language) to gain insights from data and solve scientific problems  
 + How to use a wide-range of conceptual, statistical, and graphical ways of analyzing and interpreting data  
 + How to create organized, well-documented, and reproducible scientific workflows  
 + How to create compelling and informative data visualizations  
 + How to find and access a wide-range of research-quality, publically available environmental/geoscience datasets  



> _All of the above learning goals require focused effort, practice, and reflection.  There are no shortcuts to developing the above skills and ways of thinking, however I am confident that by putting in the required effort and engagement you will accomplish the above learning goals._

## Course premise
This course will be taught as a **"flipped"** class.  This means that you will learn some of the basic material outside of class -- through online assignments/tutorials, readings, and watching videos -- while you will "learn by doing" through hands on programming exercises during class.  
...
The three texts that we will primarily rely on are listed below.  All three are freely available on the web.  Print versions of all three books are also available.  
 ...
 + [**ModernDive**](https://moderndive.com/v2/): Introductory textbook on data science and stats in R, that presents the material in a clear and concise manner.  This book is freely available online.  
 + [**R for Data Science**](https://r4ds.hadley.nz/): Excellent textbook on using R for data science. 
 + [**Geocomputation with R**](https://r.geocompx.org/): Excellent textbook on geospatial analysis using R.  
 
 
## Course sites
 + [**This website**](https://stahlm.github.io/ENS_215/Winter_2026/Home.html): The site you are on now will be updated throughout the term.  In particular the schedule will have material added on a weekly basis.
 + [**Nexus:**](https://nexus.union.edu)  You will submit all of your assignments through our Nexus class site 
 + [**DataCamp:**](https://app.datacamp.com/groups/exploring-environmental-data-w-2026/dashboard) The online assignments/tutorials can be found on our DataCamp class site
...
## Pop-quizzes
We will have pop-quizzes 6-8 times throughout the term.  The quizzes will test concepts that you have learned recently and they will help you gauge your grasp of the recent course material.  **These quizzes will take place in the first 5 minutes of class**, so make sure to be on time.  **There are no make-up pop-quizzes.**.  Your lowest pop-quiz grade will be dropped.  
...
| Assignment  |  Weight 
|---|------------|
|Homework and online tutorials| 23%|
|Lab| 25%|
|Final project| 35%|
...
![](C:/Users/stahlm/Documents/Teaching_UnionCollege/Environmental_Data_Analysis/stahlm.github.io/ENS_215/Winter_2026/Images/logo_ens_215.png){width=100px}
