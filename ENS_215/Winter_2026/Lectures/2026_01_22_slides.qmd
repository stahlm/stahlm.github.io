...
## Data visualization: Goals {.smaller}
...
## Data visualization: EDA {.smaller}
...
## Data visualization: Presentation quality figures {.smaller}
...
- `ggplot2` is widely used (you've already been using) and there are countless learning resources freely available.  
    - Both of our textbooks, [moderndive](https://moderndive.com/v2/index.html) and [R4DS](https://r4ds.hadley.nz/) largely use `ggplot2` to teach data visualizaiton


## `ggplot2` package {.smaller}
...
## Examining graphical components {.smaller}
