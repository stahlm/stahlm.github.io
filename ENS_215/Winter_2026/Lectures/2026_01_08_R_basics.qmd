...
An Quarto Notebooks (.qmd) is a blend of **R** (which is the code portion of your Notebook) and **Markdown** (the text portion).  **Markdown** is simply a system for formatting document features (e.g. text, margins, bullets, table of contents,...).
